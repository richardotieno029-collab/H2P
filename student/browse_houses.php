...
<form method="GET" class="filters" onsubmit="return handleSubmit(this, 'Applying filters...')">
    ...
    <select name="room_type">
        ...
        <option value="One Bedroom" <?= (isset($_GET['room_type']) && $_GET['room_type'] === 'One Bedroom') ? 'selected' : '' ?>>One Bedroom</option>
        <option value="Two Bedrooms" <?= (isset($_GET['room_type']) && $_GET['room_type'] === 'Two Bedrooms') ? 'selected' : '' ?>>Two Bedrooms</option>
